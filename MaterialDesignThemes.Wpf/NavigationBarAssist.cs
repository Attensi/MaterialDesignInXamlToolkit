...
namespace MaterialDesignThemes.Wpf
{
    public static class NavigationBarAssist
    {
        ...
        public static readonly DependencyProperty UnselectedIconProperty =
            DependencyProperty.RegisterAttached("UnselectedIcon", typeof(PackIconMaterialKind), typeof(NavigationBarAssist), new PropertyMetadata(PackIconMaterialKind.None));
        #endregion
        ...
        public static readonly DependencyProperty SelectedIconProperty =
            DependencyProperty.RegisterAttached("SelectedIcon", typeof(PackIconMaterialKind), typeof(NavigationBarAssist), new PropertyMetadata(PackIconMaterialKind.None));
        #endregion
